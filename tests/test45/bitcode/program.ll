...
; <label>:6:                                      ; preds = %9, %2
  ...
  %8 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i64 %7)
  ret i32 0
...
; <label>:9:                                      ; preds = %2, %9
  ...
  %14 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i64 %13)
  %15 = tail call i8* @CAT_new(i64 0) #3
  tail call void @CAT_add(i8* %15, i8* %3, i8* %4) #3
  %16 = tail call i64 @CAT_get(i8* %15) #3
  %17 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i64 %16)
