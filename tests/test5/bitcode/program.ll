...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %5 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i64 %4)
  %6 = tail call i64 @CAT_get(i8* %3) #3
  %7 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i64 %6)
  %8 = tail call i64 @CAT_get(i8* %3) #3
  %9 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0), i64 %8)
  %10 = tail call i64 @CAT_invocations() #3
  %11 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0), i64 %10)
  ret i32 0
}
