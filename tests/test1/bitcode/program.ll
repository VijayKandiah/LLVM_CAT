...
define dso_local i8* @p(i8*) local_unnamed_addr #0 {
  %2 = tail call i64 @CAT_get(i8* %0) #3
  %3 = icmp slt i64 %2, 10
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %4 = tail call i8* @p(i8* %3)
  %5 = tail call i8* @CAT_new(i64 80) #3
  %6 = tail call i8* @p(i8* %5)
  %7 = tail call i64 @CAT_get(i8* %4) #3
  %8 = tail call i64 @CAT_get(i8* %6) #3
  %9 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64 %7, i64 %8)
