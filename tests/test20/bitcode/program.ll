...
define dso_local void @function_that_complicates_everything(i8** nocapture readonly) local_unnamed_addr #0 {
  %2 = load i8*, i8** %0, align 8, !tbaa !2
  tail call void @CAT_add(i8* %2, i8* %2, i8* %2) #4
  ret void
}
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  call void @function_that_complicates_everything(i8** nonnull %3)
  %6 = tail call i64 @CAT_get(i8* %5) #4
  %7 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i64 %6)
