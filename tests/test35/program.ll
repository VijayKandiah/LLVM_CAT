...
@.str.1 = private unnamed_addr constant [23 x i8] c"Value at the end: %ld\0A\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"CAT invocations = %ld\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @my_f(i8*) local_unnamed_addr #0 {
  %2 = tail call i64 @CAT_get(i8* %0) #3
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i64 %2)
  ret void
}
