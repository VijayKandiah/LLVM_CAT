...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %4 = tail call i8* @CAT_new(i64 9) #3
  ...
  %8 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i64 %7)
  %9 = tail call i64 @CAT_invocations() #3
