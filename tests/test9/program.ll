...
define dso_local i64 @generic_C_function(i8*, i64) local_unnamed_addr #0 {
  %3 = tail call i8* @CAT_new(i64 %1) #3
  %4 = tail call i64 @CAT_get(i8* %0) #3
  %5 = icmp sgt i64 %4, 10
  br i1 %5, label %6, label %10

; <label>:6:                                      ; preds = %2
  %7 = tail call i64 @CAT_get(i8* %3) #3
  %8 = mul nsw i64 %7, 51
  %9 = sdiv i64 %8, 2
  br label %10
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %4 = tail call i64 @generic_C_function(i8* %3, i64 50)
