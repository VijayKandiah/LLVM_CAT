...
define dso_local i8* @p() local_unnamed_addr #0 {
  %1 = tail call i8* @CAT_new(i64 1) #3
  ret i8* %1
}
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  %6 = tail call i64 @CAT_get(i8* %4) #3
  %7 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64 %5, i64 %6)
