...
define dso_local void @you_cannot_take_decisions_based_on_function_names(i8*) local_unnamed_addr #0 {
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  tail call void @you_cannot_take_decisions_based_on_function_names(i8* %3)
  %4 = tail call i64 @CAT_get(i8* %3) #3
  %5 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i64 %4)
