...
define dso_local void @CAT_execution(i8*) local_unnamed_addr #0 {
  %2 = tail call i8* @CAT_new(i64 8) #3
  tail call void @CAT_add(i8* %0, i8* %2, i8* %2) #3
  ...
  tail call void @CAT_add(i8* %5, i8* %0, i8* %2) #3
  %6 = tail call i64 @CAT_get(i8* %5) #3
  %7 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i64 %6)
  ret void
}
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  tail call void @CAT_execution(i8* %3)
