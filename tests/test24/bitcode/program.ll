...
define dso_local void @a_generic_C_function(i8* nocapture readnone, i32) local_unnamed_addr #0 {
  %3 = tail call i8* @CAT_new(i64 8) #3
  %4 = icmp sgt i32 %1, 10
  br i1 %4, label %11, label %7

; <label>:5:                                      ; preds = %11
  %6 = tail call i8* @CAT_new(i64 8) #3
  br label %7

; <label>:7:                                      ; preds = %2, %5, %11
  %8 = phi i8* [ %6, %5 ], [ %12, %11 ], [ %3, %2 ]
  %9 = tail call i64 @CAT_get(i8* %8) #3
  %10 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i64 %9)
  ret void

; <label>:11:                                     ; preds = %2
  %12 = tail call i8* @CAT_new(i64 8) #3
  %13 = icmp sgt i32 %1, 100
...
define dso_local i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #0 {
  ...
  tail call void @a_generic_C_function(i8* undef, i32 %0)
  %4 = tail call i64 @CAT_invocations() #3
  %5 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i64 %4)
  ret i32 0
}
